    ...
    return(
        <div className="vertCenter">
            ...
            <div>
                ...
                <LinkedinShareButton className="removeOutline" style={{"float":"left"}} url="https://pricemydata.com">
                ...
                <TwitterShareButton className="removeOutline" style={{"float":"left"}} url="https://pricemydata.com" title={`PriceMyData says that my ${props.platformName} data is worth ${props.priceInfo.value.dataValue}! Check out how much your data is worth at PriceMyData!.`} hashtags={["dataHasValue"]}>
